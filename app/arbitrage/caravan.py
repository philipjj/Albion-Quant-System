...
def optimize_caravan(source_city: str, dest_city: str, max_weight: float, min_profit_per_kg: float = 0.0) -> dict:
    """
    ...
    with get_db_session() as db:
        ...
        opps = db.query(ArbitrageOpportunity, Item.weight).join(
            Item, ArbitrageOpportunity.item_id == Item.item_id
        ).filter(
