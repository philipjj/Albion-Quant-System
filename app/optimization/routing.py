...
from app.features.transport import calculate_route_danger_score, calculate_transport_cost


class RouteOptimizer:
    def optimize_route(
        self, possible_routes: list[dict[str, any]], item_weight: float
    ) -> list[dict[str, any]]:
        """
        ...
        for route in possible_routes:
            ...
            danger = calculate_route_danger_score(
                route.get("killboard_activity", 0), route.get("zone_type", "blue")
            )
