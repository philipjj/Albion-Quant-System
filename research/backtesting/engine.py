...
class BacktestEngine:
    ...
    def __init__(self, replay_engine: Any, strategy: Strategy, initial_cash: float = 10000.0):
    ...
    def execute_order(self, item_id: str, quantity: float, price: float, side: str):
        """
    ...
    def run(self, start_time: datetime, end_time: datetime) -> dict[str, Any]:
        """
        Runs the backtest.
        """
        total_events = 0
        ...
        from research.diagnostics.metrics import calculate_max_drawdown, calculate_sharpe_ratio
