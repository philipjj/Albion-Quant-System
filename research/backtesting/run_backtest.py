...
def main():
    ...
    parser.add_argument(
        "--start", type=str, default="2026-05-07 12:00:00", help="Start time (YYYY-MM-DD HH:MM:SS)"
    )
    parser.add_argument(
        "--end", type=str, default="2026-05-07 13:00:00", help="End time (YYYY-MM-DD HH:MM:SS)"
    )
    ...
    backtester = BacktestEngine(
        replay_engine=replay_engine, strategy=strategy, initial_cash=100000.0
    )
